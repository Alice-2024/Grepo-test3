...
Add a line with a comma separated lit of all the files that were changed in the commit message body.
Add a line in the end that says "That'e the end of the commit messgae".